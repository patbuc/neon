...
- Ask for confirmation: proceed to planning? If yes, call `worktree_make` and continue.
...
- STOP and request human confirmation before any code changes
- Create worktree via `worktree_make` after approval
